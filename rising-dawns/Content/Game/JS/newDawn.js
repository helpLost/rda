...
function workerRSS() {
    if (nomadicStart == true || nomadicStart == true) {
        if (workers[0] >= 1) {
...
function upgradet3() {
    researches3 += 1;
    console.log(researches3);
    console.log(tiers[0], tiers[1], tiers[2], tiers[3]);
    if (researches3 >= 3) {
        tiers[3] = true;
        tiers[0] = false;
        tiers[1] = false;
...
function upgradet4() {
    researches4 += 1;
    console.log(researches4);
    console.log(tiers[3], tiers[4], tiers[5], tiers[6]);
    if (researches4 >= 4) {
        tiers[6] = true;
        tiers[0] = false;
        tiers[1] = false;
