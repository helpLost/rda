...
/* Resources Addition */
function updateRSS() {
    document.getElementById("WlabelDiv").innerHTML = "Wood: " + resources[0];
    document.getElementById("SlabelDiv").innerHTML = "Stone: " + resources[1];
    document.getElementById("FlabelDiv").innerHTML = "Food: " + resources[2];
    document.getElementById("OlabelDiv").innerHTML = "Ore: " + resources[3];
    document.getElementById("HlabelDiv").innerHTML = "Hide: " + resources[4];
    document.getElementById("RlabelDiv").innerHTML = "Roots: " + resources[5];
    document.getElementById("ClabelDiv").innerHTML = "Cotton: " + resources[6];
}
...
/* Population Addition */
function updatePPL() {
    var element = document.getElementById("HlabelDiv");
    element.innerHTML = "<p id = 'HCount'>" + workers[2] + "</p>";
